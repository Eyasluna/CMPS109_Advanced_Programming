...
class shape {
   ...
   public:
      ...
      virtual void draw_border (const vertex&, const rgbcolor&, const float) const = 0;
...
class text: public shape {
   ...
   public:
      ...
      virtual void draw_border (const vertex&, const rgbcolor&, const float) const override;
