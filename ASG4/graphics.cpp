...
rgbcolor window::border_colors;
float window::border_wigth = 4;
...
void window::display() {
   ...
   objects.at(selected_obj).draw_border(window::border_colors, window::border_wigth);
   mus.draw();
   glutSwapBuffers();
}
...
void window::special (int key, int x, int y) {
   ...
   switch (key) {
      ...
      case GLUT_KEY_F1: select_object (0); break;
      case GLUT_KEY_F2: select_object (1); break;
      case GLUT_KEY_F3: select_object (2); break;
      case GLUT_KEY_F4: select_object (3); break;
      case GLUT_KEY_F5: select_object (4); break;
      case GLUT_KEY_F6: select_object (5); break;
      case GLUT_KEY_F7: select_object (6); break;
      case GLUT_KEY_F8: select_object (7); break;
      case GLUT_KEY_F9: select_object (8); break;
      case GLUT_KEY_F10: select_object (9); break;
      case GLUT_KEY_F11: select_object (10); break;
      case GLUT_KEY_F12: select_object (11); break;
      default:
